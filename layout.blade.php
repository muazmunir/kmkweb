...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
    ...
    <meta name="google-site-verification" content="AhAjUx4vkamTOJZeULaaXRPdDwcNiTrMNUwkpvnLJuc" />
    <meta charset="UTF-8" />
    ...
    <meta name="description" content="مبرة عنزة الخيرية" />
...
snaptr('init', 'd7ee8a63-7d64-4348-b8bf-2a2b76bb6734', {
...
<script type='text/javascript'>
    ...
    snaptr('init', '1bdd0719-c623-49cb-84ee-d30a2fe87232', {
    'user_email': '__INSERT_USER_EMAIL__'
    });
...
@include('tkafol.main-slider')

<!-- main-slider -->

<!-- causes-details -->

@yield('causes_detailsInclude')
<!-- causes-details -->
...
@yield('projectspagination')
<!-- causes-details -->

 <!--Causes One Start-->

 @include('tkafol.causes-one')

  <!--Causes One End-->

 <!--Join One Start-->

 @include('tkafol.join-one')

<!--Join One End-->


<!--News Page Start-->
@include('tkafol.news-page')
   <!--News Page End-->
