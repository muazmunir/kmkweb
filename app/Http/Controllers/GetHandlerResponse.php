...
if ($ResErrorText == null && $ResErrorNo == null) {
	...
	if ($ResTranData != null) {
		...
		$location_url = $config['base_url']."/kPay/result.php?".$decrytedData;
header("Location: " . $location_url);
	...
	echo $ResTranData ;
		exit();
    		...
    		$location_url =  $config['base_url']."/kPay/result.php?";

	header("Location: ".$location_url . "Error=" . $ResErrorNo . "&ErrorText=" . $ResErrorText . "&trackid=" . $ResTrackID . "&amt=" . $ResAmount . "&paymentid=" + $ResPaymentId);
	exit();
	echo $ResTranData ;
}
