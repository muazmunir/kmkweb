        ...
        <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href="{{route('saller.logout')}}"><span><i class="fas fa-unlock-alt"></i></span> Logout</a></li>
                </ul>
            </div>
        </li>
        <li>
...
<div class="row">
    <div class="col-lg-3 col-sm-6">
        <div class="counter">
           ...
           <p class="count-text ">   <a class="btn btn-outline-success" href="{{route('saller.products')}}" role="button">المشاريع </a>
            </p>
        </div>
    </div>
    <div class="col-lg-3 col-sm-6">
        <div class="counter">
            ...
            <p class="count-text "> <a class="btn btn-outline-success" href="{{route('saller.payments')}}" role="button">المدفوعات  </a></p>
        </div>
    </div>
    <div class="col-lg-3 col-sm-6">
        <div class="counter">
...
<div class="panel">
    <div class="panel_header">
        <div class="panel_title"><span> Saller {{Auth::guard('saller')->user()->name}}</span></div>
    </div>
