                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('saller.products')}}"><i class="side-menu__icon fe fe-home"></i><span class="side-menu__label">اللوحة</span></a>
                            </li>
                            <li class="sub-category">
                                <h3>الرئيسية</h3>
                            </li>
                            ...
                            <li>
                                <a class="side-menu__item has-link" href="{{route('saller.payments')}}" ><i
                            ...
                            <li>
                                <a class="side-menu__item has-link" href="{{route('saller.products')}}" ><i
                                        class="side-menu__icon fe fe-wind"></i><span
                                        class="side-menu__label">  المشاريع</span><span class="badge bg-green br-5 side-badge blink-text pb-1">Slider</span></a>
                            </li>


                            <li>
                                <a class="side-menu__item has-link" href="{{route('saller.logout')}}" ><i
                                        class="side-menu__icon fe fe-wind"></i><span
                                        class="side-menu__label"> خروج </span><span class="badge bg-green br-5 side-badge blink-text pb-1"></span></a>
                            </li>
