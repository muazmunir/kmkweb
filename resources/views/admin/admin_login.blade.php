                                    ...
                                    <div class="tab-content">
                                            ...
                                            <form action="{{route('admin.login')}}" class="d-block" method="post">
                                                ...
                                                <div class="wrap-input100 validate-input input-group" data-bs-validate="Valid email is required: ex@abc.xyz">
                                                    ...
                                                    <input class="input100 border-start-0 form-control ms-0" id="email" type="email"   name="email" value="" required autocomplete="email" autofocus placeholder="Email Address">
                                                </div>
