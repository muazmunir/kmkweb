...
<div class="row">
    <div class="col-lg-3 col-sm-6">
        <div class="counter">
           ...
           <p class="count-text "><a class="btn btn-outline-success" href="{{route('Products.index')}}" role="button">المشاريع </a></p>
        </div>
    </div>
    <div class="col-lg-3 col-sm-6">
        <div class="counter">
            ...
            <p class="count-text "><a class="btn btn-outline-success" href="{{route('paymnts.index')}}" role="button">المدفوعات </a></p>
        </div>
    </div>
    <div class="col-lg-3 col-sm-6">
        <div class="counter">
            ...
            <p class="count-text "><a class="btn btn-outline-success" href="{{route('allposts.index')}}" role="button">المقالات  </a></p>
    ...
    <div class="col-lg-3 col-sm-6">
        <div class="counter">
            <div class="counter_item">
             ...
             <p class="count-text "><a class="btn btn-outline-success" href="{{route('slider.index')}}" role="button"> سلايدر   </a></p>
        </div>
    </div>
</div>
</section>
...
<div class="panel">
    <div class="panel_header">
        <div class="panel_title"><span>{{Auth::guard('admin')->user()->name}}</span></div>
    </div>
